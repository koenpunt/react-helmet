...
var updateHtmlAttributes = function updateHtmlAttributes(attributes) {
    ...
    Object.keys(attributes).forEach(function (attribute) {
        var mappedAttribute = _HelmetConstants.HTML_TAG_MAP[attribute] || attribute;
        ...
        var indexToSave = attributesToRemove.indexOf(mappedAttribute);
        if (indexToSave !== -1) {
...
var generateHtmlAttributesAsString = function generateHtmlAttributesAsString(attributes) {
    ...
    for (var i = 0; i < keys.length; i++) {
        ...
        var mappedAttribute = _HelmetConstants.HTML_TAG_MAP[attribute] || attribute;
        var attr = typeof attributes[attribute] !== "undefined" ? mappedAttribute + "=\"" + attributes[attribute] + "\"" : "" + mappedAttribute;
